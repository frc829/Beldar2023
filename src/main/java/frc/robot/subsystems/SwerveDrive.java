...
public class SwerveDrive extends SubsystemBase {
        ...
        public ChassisSpeeds getSwerveDriveChassisSpeed() {
                ...
                return this.swerveDriveKinematics.toChassisSpeeds(frontLeftModuleState, frontRightModuleState,
                                rearLeftModuleState,
        ...
        public BooleanSupplier manualSpeedControlActive(Telemetry telemetry) {
                ...
                BooleanSupplier booleanSupplier = new BooleanSupplier() {
                        ...
                        public boolean getAsBoolean() {
                                ...
                                double fieldCentrixXSpeed = manualChassisSpeedControl
                                                .getFieldCentricSpeeds(robotAngle).vxMetersPerSecond;
                                double fieldCentrixYSpeed = manualChassisSpeedControl
                                                .getFieldCentricSpeeds(robotAngle).vyMetersPerSecond;
                                double robotCentrixXSpeed = manualChassisSpeedControl
                                                .getRobotCentricSpeeds(robotAngle).vxMetersPerSecond;
                                double robotCentrixYSpeed = manualChassisSpeedControl
                                                .getRobotCentricSpeeds(robotAngle).vyMetersPerSecond;
                                double rotationSpeed = manualChassisSpeedControl
                                                .getFieldCentricSpeeds(robotAngle).omegaRadiansPerSecond;
        ...
        public void setSwerveDriveChassisSpeed(ChassisSpeeds robotCentricChassisSpeeds) {
                ...
                if (robotCentricChassisSpeeds.vxMetersPerSecond == 0 &&
                        ...
                        frontLeftDesiredState = SwerveModuleState.optimize(frontLeftDesiredState,
                        ...
                        frontRightDesiredState = SwerveModuleState.optimize(frontRightDesiredState,
                        ...
                        rearRightDesiredState = SwerveModuleState.optimize(rearRightDesiredState,
        ...
        public CommandBase getOnRampCommand() {
                ...
                CommandBase drive = Commands.run(
                                () -> {
                                        this.setSwerveDriveChassisSpeed(new ChassisSpeeds(
                                                        4 / 1.4 * Math.sin(Math.toRadians(15)), 0, 0));
                                },
                                this);
