...
public class AlignHighForCube extends SequentialCommandGroup {

  private final double elevatorPositionMeters = 0.65;
  private final double elbowPositionDegrees = 58.0;
  private final ElevatorTiltState elevatorTiltState = ElevatorTiltState.TWO;

  public AlignHighForCube(Arm arm) {
